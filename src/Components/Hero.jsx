    ...
    <div className="w-full h-screen bg-[#001021] flex flex-col justify-between" id="hero">
      <div className="grid md:grid-cols-2 max-w-[77.5rem] m-auto">
        <div className='flex flex-col justify-center items-center md:items-start w-full px-2 py-24'>
          <h1 className='text-center text-[#5fadfc] text-6xl mb-7 font-bold md:text-start md:text-7xl'>
            Bem-vindo ao meu portfólio
          </h1>
          <h2 className='text-center font-medium mb-3  text-slate-50 md:text-start md:text-xl'>
            Aqui você pode conhecer  meus trabalhos. Fique à vontade!
          </h2>
          <p className='text-center text-lg font-thin text-slate-50 md:text-start md:text-xl'>
