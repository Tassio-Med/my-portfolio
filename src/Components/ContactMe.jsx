...
function ContactMe() {
  ...
  const sendEmail = (e) => {
    ...
    // setTimeout(() => { showResult(false) },7000);
    ...
    const validMessage = result ? showToastMessage : null;
  ...
  return(
    <div id="contact" className="w-full h-full mt-10 block justify-center items-center md:flex md:justify-center md:items-center md:mt-28 bg-[#001021]">
      <div className='text-slate-50 p-4 flex flex-col justify-center items-center md:flex md:justify-start md:items-start md:w-[450px] '>
