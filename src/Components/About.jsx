  ...
  return(
    <div id='about' className='w-full md:flex md:justify-center md:items-center bg-[#001021]'>
      <div className="flex justify-center items-center">
        <div className="relative max-w-md mx-auto md:max-w-xl min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl skills-shadow animation animation:hover">
            <div className="px-6">
                ...
                <div className="mt-6 py-6 border-t border-slate-200 text-center">
                    <div className="flex flex-wrap justify-center">
                        <div className="w-full px-4">
                            <p className="font-light leading-relaxed text-slate-600 mb-4">Amante de tecnologia, desenvolvimento e aprendizado.  Sou estudante de Desenvolvimento Web na Trybe, em  transição de carreira. Trago comigo os aprendizados  adquiridos na Gestão Ambiental melhorando-os e   abraçando novos aprendizados tanto nas Hard Skills como   Soft Skills, agora focado no Desenvolvimento Web.</p>
                        </div>
                    </div>
                </div>
            </div>
